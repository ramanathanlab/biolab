...
def parse_config_yaml(config_path: Path) -> dict[str, str]:
    ...
    dict[str, str]
        Dictionary containing:
          ...
          - display_name: A human-readable name (derived from name).
          - pretrained_model_name_or_path: HF model specifier if available.
          - output_dir: The output directory specified in the configuration
    """
...
def parse_metric_file(metric_file: Path, model_info: dict[str, str]) -> pd.DataFrame:
    ...
    model_info : dict[str, str]
        ...
        (including 'model_id', 'display_name', and 'output_dir').
    ...
    # Infer task name from the file name,
    # e.g. "Ankh_CaLM-Meltome.metrics" -> "CaLM-Meltome"
